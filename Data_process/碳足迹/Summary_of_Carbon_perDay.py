...
df_summer.to_csv("all_element_carbon_summer.csv", index=False, encoding='utf-8-sig')
df_winter.to_csv("all_element_carbon_winter.csv", index=False, encoding='utf-8-sig')
